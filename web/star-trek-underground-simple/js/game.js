(function() {
    ...
    function create() {
        ...
        startTxt = game.add.text(game.world.centerX, game.world.centerY + 400*objScale, "按下『空白鍵』開始玩", startTxtStyle);
        ...
        ggTxt = game.add.text(game.world.centerX, game.world.centerY, "挑戰失敗", ggTxtStyle);
        ...
        var winTxtStyle = { fill: "#fdcf58", align: "center", fontSize: 120 * objScale };
        winTxt = game.add.text(game.world.centerX, game.world.centerY, "挑戰成功！", winTxtStyle);
    ...
    function update() {
        ...
        if (gameStart) {
            ...
            if (!gameEnding) {
                ...
                gameWin = true;
                gameStart = false;
                for (var i = rocks.length - 3; i < rocks.length; i++) {
